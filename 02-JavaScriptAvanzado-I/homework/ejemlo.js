...
// var a = 5;//
// var b = 10;//
// var c = function (a, b, c) {// la espresa  // contexto
//     //
//     //var a = 8; var b = 9; var c = 10
//    var x = 10;//
//    console.log(x);//10
//    console.log(a);//8
//    var f = function (a, b, c) {// la declara // contexto
//       b = a;// b= 8
//       console.log(b);// 8
//       b = c;// b = 10
//       var x = 5;
...
// console.log(baz);// error -> baz no existe
// foo();
// function foo() {// se eleva
//    console.log('Hola!');
// }
// // "hola"
// var bar = 1;
...
// let pm = 'Franco';
// if (true) {
//    var instructor = 'The Flash'; // lo pisa
